...
const navItems = [
  { id: 1, title: "SENSORS", link: "/pricing" },
  { id: 2, title: "ANALYSIS", link: "/about-us" },
  { id: 3, title: "COACHING", link: "/contact" },
  ...
  return (
    <nav className="fixed top-4 left-0 w-full z-50 flex justify-center font-['Montserrat',sans-serif]">
      <div className="flex items-center justify-between w-[90%] md:w-[85%] hover:bg-[#171717] transition duration-400 rounded-md py-4 px-12 md:px-6">
        ...
        {/* Sign Up Button */}
        <Link href="/waitlist">
          <button className="hidden cursor-pointer md:inline-flex items-center justify-center px-6 py-2 rounded-md font-lato font-medium text-white bg-black transition-all duration-300 hover:brightness-110 hover:scale-[1.05] active:scale-[0.98] shadow-md hover:shadow-lg">
            Join Waitlist
          </button>
        </Link>
        ...
        <div className="absolute top-full left-0 w-[80%] bg-[#111111] overflow-hidden rounded-2xl shadow-xl border-t border-white/10 animate-slideDown mt-4 ml-12">
          ...
          <div className="flex justify-center pb-6">
            <Link href="/waitlist" className="w-[85%]">
              <button
                className="w-full py-3 rounded-xl font-semibold text-white bg-black shadow-lg hover:brightness-110 hover:scale-105 active:scale-95 transition-transform duration-200"
                onClick={() => setIsOpen(false)}
              >
                Join Waitlist
              </button>
