    ...
    <>
      ...
      <section className="relative h-screen w-full flex items-center overflow-hidden px-6 font-['Montserrat',sans-serif]">
        ...
        <div className="relative z-20 flex flex-col items-start ml-10 mb-40 justify-center text-white max-w-[90%] sm:max-w-[600px] lg:max-w-[800px] xl:ml-20">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-thin mt-6 text-white max-w-[600px]">
            The world’s first AI track coach built for performance.
          </p>
          <Link href="/waitlist">
            <button className="hidden cursor-pointer mt-10 md:inline-flex items-center justify-center px-10 py-3 rounded-md text-2xl font-medium text-white bg-black transition-all duration-300 hover:brightness-110 hover:scale-[1.05] active:scale-[0.98] shadow-md hover:shadow-lg">
              Join RVN
            </button>
          </Link>
        </div>
